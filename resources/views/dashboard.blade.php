                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded bg-soft-primary img-fluid avatar-40 me-3"
                                            src="{{ asset('assets/images/shapes/05.png') }}" alt="profile">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded bg-soft-primary img-fluid avatar-40 me-3"
                                            src="{{ asset('assets/images/shapes/02.png') }}" alt="profile">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded bg-soft-primary img-fluid avatar-40 me-3"
                                            src="{{ asset('assets/images/shapes/03.png') }}" alt="profile">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="rounded bg-soft-primary img-fluid avatar-40 me-3"
                                            src="{{ asset('assets/images/shapes/04.png') }}" alt="profile">
                    ...
                    <div class="w-100">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="progress bg-soft-gray shadow-none w-50" style="height: 6px">
                                <div class="progress-bar bg-secondary" data-toggle="progress-bar" role="progressbar"
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-top">
                    ...
                    <div class="profile-media ms-3 d-flex">
                        ...
                        <div class="ms-3">
                            <h6 class="mb-0">New user added in Crud</h6>
                        </div>
                    </div>
                </div>
                <div class="d-flex align-items-top">
                ...
                <div class="d-flex align-items-top">
                    ...
                    <div class="profile-media ms-3 d-flex pb-0">
                        <div class="profile-dots-pills border-warning"></div>
                        <div class="ms-3">
                            <h6 class="mb-0">New order Placed <span class="text-primary">#87444892</span> of
                                Dashboard</h6>
                        </div>
                    </div>
                </div>
