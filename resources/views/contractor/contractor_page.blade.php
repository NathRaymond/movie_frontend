...
@section('contents')
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-warning rounded" data-placement="top"
                                                        ...
                                                        id="edit-user" data-id="{{ $contractor->id }}"
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger rounded" data-placement="top"
                                                        ...
                                                        data-id="{{ $contractor->id }}"><i class="fa fa-trash">
                                                            <span class="btn-inner">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Edit Contractor</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    </button>
                </div>
                <div class="modal-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            function performDelete(el, user_id) {
                try {
                    $.get('{{ route('delete-contractor') }}?id=' + user_id,
                        function(data, status) {
                            console.log(status);
                            console.table(data);
                            if (status === "success") {
                                let alert = swal("Contractor deleted successfully.");
