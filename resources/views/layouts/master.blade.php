...
<body class="  ">
    ...
    <aside class="sidebar sidebar-base sidebar-white sidebar-default navs-rounded-all " id="first-tour">
                                                ...
                                                <div class="text-primary ">
                                                    <svg width="60" height="27" viewBox="0 0 60 27"
                                                        ...
                                                        <rect x="0.375" y="0.375" width="59.25"
                                                            height="26.25" rx="4.125" fill="white">
                                                        </rect>
                                                        <circle cx="9.75" cy="9.75" r="3.75"
                                                            fill="#80868B"></circle>
                                                        <rect x="16.5" y="8.25" width="37.5"
                                                            height="3" rx="1.5" fill="#DADCE0">
                                                        </rect>
                                            ...
                                            <label
                                                ...
                                                <div class="text-primary ">
                                                    <svg width="60" height="27" viewBox="0 0 60 27"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <rect x="0.375" y="0.375" width="59.25"
                                                            height="26.25" rx="4.125" fill="#1E2745">
                                                        </rect>
                                                        <circle cx="9.75" cy="9.75" r="3.75"
                                                            fill="#80868B"></circle>
                                                        <rect x="16.5" y="8.25" width="37.5"
                                    ...
                                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                                        <div data-setting="radio">
                                            ...
                                            <label class="btn btn-border d-block"
                                                for="page-layout-boxed">Boxed</label>
                                        </div>
                                        <div data-setting="radio">
        ...
        <script src="{{ asset('assets/js/plugins/swiper-slider.js') }}" defer></script>
        <!-- Lodash Utility -->
